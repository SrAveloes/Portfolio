...
function doGet(e) {
  ...
  return ContentService.createTextOutput(JSON.stringify(result))
    ...
    apostas: {
      title: "Modelagem de Séries Temporais e GGR para Apostas",
      title_en: "Time Series Predictive Modeling & GGR Analytics for iGaming",
      tags: ["Power BI", "ARIMA / SARIMA", "Loterias & Apostas", "DAX"],
      tags_en: ["Power BI", "ARIMA / SARIMA", "Lottery & Betting", "DAX"],
      problem: "Falta de visão unificada do volume de vendas, retenção de apostadores, taxa de aquisição (CAC), vendas por loteria e margem operacional líquida (GGR).",
      problem_en: "Lack of unified visibility over betting volumes, player retention cohorts, customer acquisition costs (CAC), and Gross Gaming Revenue (GGR).",
      solution: "Painel analítico integrando métricas de vendas, ticket médio, análise de cohort de retenção de usuários ao longo do tempo e taxa de conversão por sessões. Inclui aplicação de séries temporais com algoritmos ARIMA/SARIMA em Python para prever volumes de jogos.",
      solution_en: "Analytical dashboard combining sales metrics, average ticket, cohort retention analysis, and session conversion rates integrated with Python ARIMA/SARIMA time series forecasting models.",
      tech: "Power BI, DAX avançado, Modelagem SQL, Algoritmos Estatísticos (ARIMA/SARIMA em Python).",
      tech_en: "Power BI, Advanced DAX, SQL Modeling, Statistical Forecasting (ARIMA/SARIMA in Python).",
      result: "Identificação ágil de tendências de apostas com alta precisão preditiva, permitindo o provisionamento estratégico e otimização de campanhas de retenção.",
      result_en: "Agile identification of gaming trends with high forecasting accuracy, optimizing player retention campaigns and capital allocation.",
      hasVideo: false,
      hasEmbed: true,
      ...
      images: ["assets/apostas_dashboard.png", "assets/apostas_vendas.png", "assets/apostas_sumario.png"],
      showSupabasePrint: false,
      isLandscape: true
    },
    monitoramento: {
  ...
  const translations = {
    pt: {
      ...
      p6_title: "Modelagem de Séries Temporais e GGR para Apostas",
      p6_prob: "Falta de visão unificada do volume de apostas, perfil dos apostadores e margem operacional líquida (GGR).",
      p6_sol: "Dashboard analítico unificado conectado a banco de dados de transações com aplicação integrada de algoritmos estatísticos ARIMA/SARIMA para prever volumes futuros de jogos.",
      p6_tech: "Power BI, DAX avançado, Modelagem SQL, Algoritmos Estatísticos (ARIMA/SARIMA em Python).",
      p6_res: "Identificação ágil de tendências de apostas com alta precisão preditiva, permitindo o provisionamento estratégico e otimização de campanhas de retenção.",
    ...
    en: {
      ...
      p6_title: "Time Series Predictive Modeling & GGR Analytics for iGaming",
      p6_prob: "Lack of unified visibility over betting volumes, player retention cohorts, customer acquisition costs (CAC), and Gross Gaming Revenue (GGR).",
      p6_sol: "Analytical dashboard combining sales metrics, cohort retention analysis, and session conversion rates integrated with Python ARIMA/SARIMA time series forecasting models.",
      p6_tech: "Power BI, Advanced DAX, SQL Modeling, Statistical Forecasting (ARIMA/SARIMA in Python).",
      p6_res: "Agile identification of gaming trends with high forecasting accuracy, optimizing player retention campaigns and capital allocation.",
      areas_tag: "Expertise",
